...
<body>
	  ...
	  <ul class="nav navbar-nav navbar-right">
		      <!-- li class="dropdown"-->
		        ...
		        <ul class="dropdown-menu"-->
		         ...
		         <li> <a href="adlogout.htm">Log out</a></li>
	  </ul>
	</nav>
	...
	<div class="container" style="margin-top:50px">
	  ...
	  <div class="row">
	    ...
	    <div class="col-md-12" id="users"> 
	      ...
	      <td>Gender</td>
	      <td>Birthday</td>
	      <td><button type="button" id="pdfBtn" class="btn btn-primary">Pdf</button></td>
	      </tr>
	...
	document.getElementById("pdfBtn").onclick = function () {
        location.href = "http://localhost:8080/controller/report.pdf";
    };
	...
	xmlHttp.open("GET","admin-deleteUser.htm?cusid="+uid,true);
	xmlHttp.send();  
    }
	</script>
